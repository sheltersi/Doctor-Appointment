...
<body>
  ...
  <header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +27 62 135 4287</a>
              <span class="divider">|</span>
              <a href="mailto:accproject50@gmail.com"><span class="mai-mail text-primary"></span> mail@example.com</a>
            </div>
          </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="{{url('/')}}"><span class="text-primary">Richfield</span>-Clinic</a>
...
<td><a class="bt btn-danger " onclick="return confirm('are you sure to delete this appointment')" href="{{url('cancel_appoint',$appoints->id)}}">Cancel</a></td>
</tr>
